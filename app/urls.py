...
urlpatterns = [
    ...
    path('television/,<slug:data>', views.television, name='tvdata'),
    path('headspeaker/', views.headspeaker, name='hspeaker'),
    path('headspeaker/,<slug:data>', views.headspeaker, name='hspeakerdata'),
